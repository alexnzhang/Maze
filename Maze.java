...
public abstract class Maze {
    ...
    /* Maze Information ****************************************************/
	/**
	 * Create an array of Client class for better management of them.
	 */
	public int NUM_CLIENTS;
	public Client[] clientList;
	
	/**
	 * Create a parameter to record the total number of processes in the maze.
	 */
     ...
     * @param client {@link Client} to be added to the {@link Maze}.
     */
    public abstract void addRemoteClient(RemoteClient client, int mode);
    
    /** 
     * To check if a client is able to fire.
     * @param client {@link Client} that is firing.
     * @return <code>false</code> on failure, <code>true</code> on success. */
    public abstract boolean testFire(Client client);
    /** 
    ...
    /** 
     * Attempt to test if a {@link Client} in the {@link Maze} can move forward.
     * @param client {@link Client} to move.
     * @return <code>true</code> if successful, <code>false</code> if failure. 
     */
    public abstract boolean testClientForward(Client client);
    
    /** Attempt to test if a {@link Client} in the {@link Maze} can move backward.
     * @param client {@link Client} to move.
     * @return <code>true</code> if successful, false if failure. 
     */
    public abstract boolean testClientBackward(Client client);
    
    /**
     * Attempt to remove lock of the target cell when this movement fails.
     */
    public abstract void unlockCell(Client client, String direction);
